  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested community" do
        ...
        Community.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => community.id, :community => {'these' => 'params'}
      end

      it "assigns the requested community as @community" do
        community = Community.create! valid_attributes
        put :update, :id => community.id, :community => valid_attributes
        assigns(:community).should eq(community)
      end
